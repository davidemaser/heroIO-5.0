...
class Alert {
  ...
  build(mess, state) {
    let dispLeng = 10000;
    if (__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].dialog === true) {
      const mPane = '.panel-body.bottom_level_bt';
      if (state === __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].params.e) {
        $(mPane).find(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.g).removeClass('allGood').removeClass('glyphicon-ok').addClass('allBad').addClass('glyphicon-remove');
        dispLeng = __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].animation.d.max;
      } else if (state === __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].params.g) {
        $(mPane).find(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.g).removeClass('allBad').removeClass('glyphicon-remove').addClass('allGood').addClass('glyphicon-ok');
        dispLeng = 10000;
      }
      $(mPane).slideDown();
...
"use strict";
/* WEBPACK VAR INJECTION */(function($, global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Config__ = __webpack_require__(1);
...
const Init ={
  ...
  initializeForm: () => {
    $.ajax({
      type: __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].methods.g,
      url: __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.form.l,
      success(data) {
        const dataBlock = data.layout;
        let htmlBlock = `<div id="entry1" class="clonedInput" ${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.s}="1"><form action="${dataBlock.form_action}" method="${dataBlock.method}" id="${dataBlock.form_id}" role="form">`;
  ...
  switchModes: (va) => {
    if (va === 'hello') {
      ...
      new __WEBPACK_IMPORTED_MODULE_1__Alert__["a" /* default */]('Switched to Hello Banner Creation mode', 'good');
    } else {
      $('*[data-role="hello"]').css('display', 'none');
      $('*[data-role="hero"]').attr('style', '');
      global.pfExport = 'hero';
      $('.submit_json').attr('data-nmode', 'hero');
      new __WEBPACK_IMPORTED_MODULE_1__Alert__["a" /* default */]('Switched to Hero Banner Creation mode', 'good');
    }
  },
  /**
  ...
  initializeTheme: () => {
    if (window.localStorage) {
      let tm = localStorage.getItem(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].storage.t);
      if (tm === null || tm === undefined) {
        $('html').attr(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.t, 'light');
      } else {
        $('html').attr(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.t, tm);
      }
    } else {
      $('html').attr(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.t, 'light');
    }
  ...
  initHelp() {
    $.ajax({
      ...
      error: () => {
        new __WEBPACK_IMPORTED_MODULE_1__Alert__["a" /* default */]('Unable to load Help Contents from JSON source', 'error');
      }
    });
  },
  /**
  ...
  setHeadSec() {
    try {
      let isReady = localStorage.getItem(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].storage.n);
      if (isReady !== null) {
        $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.l).css('display', 'inline-block');
        $('#import_json').css('display', 'block');
        $('.lsLoad').find('li').remove();
        let a = localStorage.getItem(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].storage.n).split(',');
        let long = a.length;
        if (long > 1) {
          for (let i = 0; i < long; i++) {
            if (a[i] !== '') {
              $('.lsLoad').append(`<li><a href="#" class="loadItem" ${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.i}="${a[i]}">${a[i]}</a></li>`);
            }
          }
        } else {
          $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.l).hide();
        }
      } else {
        $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.l).css('display', 'none');
  ...
  getVersion(init) {
    try {
      $.ajax({
        type: __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].methods.g,
        url: __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].version,
        success: (data) => {
  ...
  tagNew(ver) {
    ...
    $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].dom.b).append(cssBlock).find(`a[data-version="${ver}"]`).attr('title', 'This feature is new to the current version');
  },
  initVersionUpdate() {
    $('.init-update').remove();
    ...
    $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].dom.b).append(pageData).on('click', '.btn-update.true', () => {
      location.reload();
    }).on('click', '.btn-update.false', () => {
      $('.btn-update.false').parent().parent().parent().parent().remove();
      new __WEBPACK_IMPORTED_MODULE_1__Alert__["a" /* default */]('Version update stopped. The update prompt will reappear at the next update interval.', 'good');
    })
  }
};
...
class Language{
  ...
  languageManager(lng, init){
    let newLang;
    lng = $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].dom.h).attr('data-language') || lng;
    switch (lng) {
      case "en_EN":
        newLang = 'fr_FR';
        $('.app_lang_toggle').attr('data-set-lang', newLang);
        init !== true ? $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].dom.h).attr('data-language', newLang) : null;
        break;
      case "fr_FR":
        newLang = 'en_EN';
        $('.app_lang_toggle').attr('data-set-lang', newLang);
    ...
    try {
      ...
      $.ajax({
        type: __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].methods.g,
        url: `${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].languageRoot}${newLang}.json`,
        success(data) {
...
class Errors{
  ...
  errorHandler() {
    let errorLog = [];
    let a = JSON.parse($(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.o}[${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.r}="output"]`).find('textarea').val()).hero;
    let b = a.length;
    let c = 0;
    for (let i = 0; i < b; i++) {
      if (a[i].date.start === '') {
    ...
    if (c > 0) {
      $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.el).css('display', 'inline-block');
      $('.errorListing').empty();
      ...
      $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.el).css('display', 'none');
    }
  };
  /**
  ...
  registerErrorButtons(num, elem, item, prob, die) {
    $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.bo).on('click', `.errorItem[${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.i}="${item}"]`, () => {
      if (die === true) {
        $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.e + num).find(`.${elem}`).css('background-color', 'rgba(238, 54, 54, 0.3)').css('border-color', 'red').attr('placeholder', 'Leaving this field empty will cause the hero banner function to fail');
      } else {
        $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.e + num).find(`.${elem}`).css('background-color', 'rgba(238, 162, 54, 0.3)');
      }
      $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.o).hide();
      $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.r).css('overflow', 'auto');
      $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.r).animate({
        scrollTop: $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.e + num} .${elem}`).offset().top - 100
      }, __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].animation.d.min);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Config__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Utilities__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Alert__ = __webpack_require__(2);
/**
 * Created by David Maser on 09/06/2017.
 */
...
const Items = {
   ...
   */
  addItems() {
    if ($(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.o).css('display') === 'block') {
      $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.o).css('display', 'none');
    }

    let // Checks to see how many "duplicatable" input fields we currently have
      num = $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.cl).length; // create the new element via clone(), and manipulate it's ID using newNum value

    let // The numeric ID of the new input field being added, increasing by 1 each time
      newNum = new Number(num + 1);

    let newElem = $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.e + num).clone().attr('id', `entry${newNum}`);
    ...
    newElem.attr(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.s, newNum);
    ...
    newElem.find(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.c).attr(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.d, newNum);
    newElem.find('.check_alt_image').attr(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.d, newNum);
    ...
    $('.snapTo').append(`<li><a href="#" class="gotoItem" ${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.i}="${newNum}">Item ${newNum}</a></li>`);
    $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.r).animate({
      scrollTop: $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.e + newNum).offset().top - 60
    }, __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].animation.d.min);
    $('.btn-group.bigboy:not(.helpMePlease)').last().find('ul').append(`<li class="divider" data-role="hero"></li><li><a class="removeThisItem" ${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.i}="${newNum}" href="javascript:;">Remove</a></li><li class="divider"></li><li><a class="moveUpThisItem" ${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.i}="${newNum}" href="javascript:;">Move Up<span class="glyphicon glyphicon-arrow-up"></span></a></li><li><a class="moveDownThisItem" ${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.i}="${newNum}" href="javascript:;">Move Down<span class="glyphicon glyphicon-arrow-down"></span></a></li><li class="divider" data-role="hero"></li><li data-role="hero"><a class="addConditions" data-hero="1" data-role="hero" data-lang-id="action17" data-version="3.2.1">Toggle Conditions</a></li><li data-role="hero"><a class="hideItem" data-hero="1" data-role="hero" data-lang-id="action18" data-version="3.2.1">Hide Item</a></li>`);
    $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.e + newNum).find('.mod-radio').find('input').first().prop('checked', true);
    __WEBPACK_IMPORTED_MODULE_1__Utilities__["a" /* Utilities */].scrollState('a');
    new __WEBPACK_IMPORTED_MODULE_2__Alert__["a" /* default */]('Item Added', 'good');
  },
  /**
  ...
  addMulti : (num) => {
    ...
    new __WEBPACK_IMPORTED_MODULE_2__Alert__["a" /* default */]('Items Added', 'good');
  },
  /**
   ...
   */
  deleteItems : (elem) => {
    if ($(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.cl).length > 1) {
      if ($(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.o).css('display') === 'block') {
        $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.o).css('display', 'none');
      }
      ...
      if (elem === 'last') {
        ...
        $('.snapTo').find(`.gotoItem[${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.i}="${b}"]`).parent().remove();
        __WEBPACK_IMPORTED_MODULE_1__Utilities__["a" /* Utilities */].scrollState('a');
      } else {
        $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.e + elem).slideUp('slow', function () {
          $(this).remove();
          // if only one element remains, disable the "remove" button
          if (elem - 1 === 1)
            $('.btnDel').attr('disabled', true);
        ...
        $('.snapTo').find(`.gotoItem[${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.i}="${elem}"]`).parent().remove();
        __WEBPACK_IMPORTED_MODULE_1__Utilities__["a" /* Utilities */].scrollState('a');
      }
      new __WEBPACK_IMPORTED_MODULE_2__Alert__["a" /* default */]('Last Item Removed', 'good');
   ...
   */
  resetItems: () => {
    if ($(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.re).length > 0) {
      $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.w).find(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.cl).sort((a, b) => $(a).attr('id').replace('entry', '') - $(b).attr('id').replace('entry', '')).appendTo(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.w);
      $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.re).remove();
      new __WEBPACK_IMPORTED_MODULE_2__Alert__["a" /* default */]('Items reset to their original position', 'good');
    } else {
      new __WEBPACK_IMPORTED_MODULE_2__Alert__["a" /* default */]('All items are in their original position', 'error');
    }
  }
};
...
const Storage = {
  ...
  saveNodeToLS(val, name) {
    ...
    if (window.localStorage) {
      ...
      new __WEBPACK_IMPORTED_MODULE_1__Alert__["a" /* default */]('Data Saved To Local Storage', 'good');
    }
  },
  choseLocalSave() {
    try {
      $('#loadandsave-zone').attr(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.r, 'load').css('display', 'block');
      let a = localStorage.getItem(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].storage.n);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Config__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Errors__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Alert__ = __webpack_require__(2);
/**
 * Created by David Maser on 09/06/2017.
 */
...
const Utilities = {
  ...
  jumpToHelper(a) {
    $('.help_panel_holder').animate({
      scrollTop: $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.hi}[data-helper="${a}"]`).offset().top,
      duration: __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].animation.d.min
    });
    $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.hi).animate({
      opacity: 0.4,
      duration: __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].animation.d.min
    });
    $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.hi}[data-helper="${a}"]`).animate({
      opacity: 1,
      duration: __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].animation.d.min
    });
  },
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!function(a){"use strict";if(true)!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0),__webpack_require__(9)], __WEBPACK_AMD_DEFINE_FACTORY__ = (a),
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./webFont.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./webFont.css");
...
"use strict";
/* WEBPACK VAR INJECTION */(function($, global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Config__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Utilities__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Items__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Json__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Preview__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Language__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Validators__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Init__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Storage__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Alert__ = __webpack_require__(2);
/**
 * Created by David Maser on 09/06/2017.
 */
...
$(function () {
  $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.bo).on('click', '.btnAdd', () => {
    ...
    new __WEBPACK_IMPORTED_MODULE_5__Language__["a" /* Language */](lng);
  }).on('click', '.overlay_close', () => {
    $('.overlay_close').parent().parent().hide();
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).css('overflow', 'auto');
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].messages.overlay).css('display', 'none')
  }).on('click', '.select_content', () => {
    const $this = $(`${__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.b} textarea`);
    $this.select();
    ...
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).animate({
      scrollTop: $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.e + a).offset().top - 60
    }, __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min);
    if ($(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.o).css('display') == 'block') {
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).css('overflow', 'auto');
    ...
    if ($(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.he).css('display') == 'block') {
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.he).css('display', 'none');
    }
    ...
    $('#query-zone').toggle();
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).animate({scrollTop: 0}, __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min);
    if ($(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.o).css('display') == 'block') {
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.o).css('display', 'none');
    }
    if ($(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.h).css('display') == 'block') {
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.h).css('display', 'none');
    }
    $('.num_select').focus();
  }).on('click', __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.c, (e) => {
    const a = $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.c).data('handler');
    __WEBPACK_IMPORTED_MODULE_6__Validators__["a" /* Validator */].validateImage('main', a);
    e.preventDefault();
    ...
    __WEBPACK_IMPORTED_MODULE_6__Validators__["a" /* Validator */].validateImage('alt', a);
    e.preventDefault();
  }).on('click', '.overlay_validate', () => {
    __WEBPACK_IMPORTED_MODULE_3__Json__["a" /* Json */].validateJSON();
  }).on('click', '.overlay_trim', () => {
    __WEBPACK_IMPORTED_MODULE_1__Utilities__["a" /* Utilities */].cleanWhitespace();
    new __WEBPACK_IMPORTED_MODULE_9__Alert__["a" /* default */]('Whitespace and line breaks have been removed.', 'good');
  }).on('click', '.previewItem.large', (e) => {
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).animate({scrollTop: sPos}, __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min).css('overflow', 'hidden');
    const a = $('.previewItem.large').data('hero');
    new __WEBPACK_IMPORTED_MODULE_4__Preview__["a" /* Preview */](a, 'large', global.pfLang);
    e.preventDefault();
  }).on('click', '.previewItem.small', (e) => {
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).animate({scrollTop: sPos}, __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min).css('overflow', 'hidden');
    const a = $('.previewItem.small').data('hero');
    new __WEBPACK_IMPORTED_MODULE_4__Preview__["a" /* Preview */](a, 'small', global.pfLang);
    e.preventDefault();
  }).on('click', '.removeThisItem', () => {
    const a = $('.removeThisItem').data('item');
    __WEBPACK_IMPORTED_MODULE_2__Items__["a" /* Items */].deleteItems(a);
  }).on('click', '.loadItem', () => {
    ...
    if ($(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.he).css('display') === 'block') {
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).animate({scrollTop: 0}, __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min).css('overflow', 'hidden');
    } else {
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).css('overflow', 'auto');
    }
    if ($(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.o).css('display') === 'block') {
    ...
    if ($(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.h).css('display') === 'block') {
      ...
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).css('overflow', 'auto');
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.h).find('.render_output').empty();
    }
  }).on('click', __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].buttons.mode, () => {
    let a = $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].dom.b).attr('data-nmode');
    if (a === 'hero') {
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].dom.b).attr('data-nmode', 'hello');
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].buttons.mode).attr('data-nmode', 'hello');
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].buttons.mode).html('Switch to Hero Banner Mode');
      __WEBPACK_IMPORTED_MODULE_7__Init__["a" /* Init */].switchModes('hello')
    } else if (a === 'hello') {
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].dom.b).attr('data-nmode', 'hero');
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].buttons.mode).attr('data-nmode', 'hero');
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].buttons.mode).html('Switch to Hello Bar Mode');
      __WEBPACK_IMPORTED_MODULE_7__Init__["a" /* Init */].switchModes('hero')
    }
  }).on('click', '.btnDel', () => {
    __WEBPACK_IMPORTED_MODULE_2__Items__["a" /* Items */].deleteItems('last');
  }).on('click', '.hideItem', function (e) {
    __WEBPACK_IMPORTED_MODULE_8__Storage__["a" /* Storage */].cacheClickedItem($(this));
    e.preventDefault();
  }).on('click', '.submit_json', () => {
    let a = $('.submit_json').attr('data-nmode');
    __WEBPACK_IMPORTED_MODULE_3__Json__["a" /* Json */].prepareJSON('full', null, a);
  }).on('click', '.translate_json', () => {
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].messages.overlay).html('');
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).animate({scrollTop: 0}, __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min).css('overflow', 'hidden');
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.o).attr(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].handlers.r, 'translate').css('display', 'block').find('#output_code').val('').attr('placeholder', 'Paste you code here');
  }).on('click', '.translate_from_server', () => {
    let xPath = $('.translate_from_server').attr('tlh');
    __WEBPACK_IMPORTED_MODULE_3__Json__["a" /* Json */].loadFromServer(xPath);
  }).on('click', '.save_json', function () {
    if (__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].save === true) {
      __WEBPACK_IMPORTED_MODULE_8__Storage__["a" /* Storage */].doLocalSave();
    } else {
    ...
    __WEBPACK_IMPORTED_MODULE_8__Storage__["a" /* Storage */].choseLocalSave();
  }).on('click', '.planb_friendly', (e) => {
    __WEBPACK_IMPORTED_MODULE_1__Utilities__["a" /* Utilities */].planBify();
    e.preventDefault();
  }).on('click', '.overlay_translate', () => {
    __WEBPACK_IMPORTED_MODULE_3__Json__["a" /* Json */].traverseJSON(false);
  }).on('click', '.errors_reset', () => {
    $('input,select').attr('style', '').attr('placeholder', '');
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].errors.list).css('display', 'none');
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).css('overflow', 'auto');
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.i).find('.input_alerts').remove();
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.i).contents().unwrap();
    new __WEBPACK_IMPORTED_MODULE_9__Alert__["a" /* default */]('Errors Reset', 'good');
    ...
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.i).contents().unwrap();
    $('.reordered').remove();
    new __WEBPACK_IMPORTED_MODULE_9__Alert__["a" /* default */]('Form Reset To Default', 'good');
    e.preventDefault();
  }).on('click', '.itemize_reset', e => {
    __WEBPACK_IMPORTED_MODULE_2__Items__["a" /* Items */].resetItems();
    e.preventDefault();
  }).on('click', '.form_local_reset', e => {
    __WEBPACK_IMPORTED_MODULE_8__Storage__["a" /* Storage */].doLocalSave('reset');
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.l).hide();
    e.preventDefault();
    ...
    __WEBPACK_IMPORTED_MODULE_1__Utilities__["a" /* Utilities */].jumpToHelper(a);
  }).on('click', '.image_count', () => {
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].images.counter).attr('style', '');
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].images.counter).text('Shopify CDN');
    ...
    if ($(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.ro).children().not('.preview_warning').length > 0) {
      new __WEBPACK_IMPORTED_MODULE_4__Preview__["a" /* Preview */](global.pfHero, global.pfMode, global.pfLang)
    }
    new __WEBPACK_IMPORTED_MODULE_9__Alert__["a" /* default */]('Preview language changed', 'good');
    e.preventDefault();
  }).on('click', '.panel-body.bottom_level_bt', () => {
    $('.panel-body.bottom_level_bt').slideUp();
  }).on('click', '.show_me_how', () => {
    let a = $('.show_me_how').data('target') - 1;
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).animate({scrollTop: 0}, {
      duration: __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min,
      complete() {
        $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.he).show();
        __WEBPACK_IMPORTED_MODULE_1__Utilities__["a" /* Utilities */].jumpToHelper(a);
      }
    }).css('overflow', 'hidden');
  }).on('click', '.helpItemReset', () => {
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.hi).animate({
      opacity: 1
    }, __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min);
  }).on('click', '.settings_toggle', function (e) {
    let a = $(this).attr('data-theme');
    $('html').attr(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].handlers.t, a);
    if (window.localStorage) {
      localStorage.setItem('pgb_Theme', a);
    }
    new __WEBPACK_IMPORTED_MODULE_9__Alert__["a" /* default */]('Theme Settings Updated', 'good');
    e.preventDefault();
  }).on('click', '.moveUpThisItem', function (fn) {
    let a = $(this).data('item');
    let b = a - 1;
    let c = $(this).parent().parent().parent().parent().parent().parent();
    let d = $(c).closest(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.cl).prev();
    let e = $(c).data('split');
    $(c).attr(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].handlers.s, (e - 1));
    $(c).insertBefore(d);
    $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.r).animate({
      scrollTop: $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.e + a).offset().top - 60
    }, __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min);
    ...
    new __WEBPACK_IMPORTED_MODULE_9__Alert__["a" /* default */]('Item Order Changed', 'good');
    fn.preventDefault();
  }).on('click', '.moveDownThisItem', function (fn) {
    let a = $(this).data('item');
    let b = a - 1;
    let c = $(this).parent().parent().parent().parent().parent().parent();
    let d = $(c).closest(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.cl).next();
    let e = $(c).data('split');
    let f = $(d).attr('id');
    if (f.includes('entry')) {
      $(c).attr(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].handlers.s, (e + 1));
      ...
      new __WEBPACK_IMPORTED_MODULE_9__Alert__["a" /* default */]('If I move down any further, I\'ll be off the page.', 'error');
    }
    fn.preventDefault();
    ...
    if (e.keyCode === 13) {
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].selectors.number).trigger("enterKey");
      __WEBPACK_IMPORTED_MODULE_2__Items__["a" /* Items */].addMulti($(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].selectors.number).val());
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].selectors.number).parent().parent().parent().parent().hide();
    }
  }).on('keyup', __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].selectors.lsl, (e) => {
    if (e.keyCode === 13) {
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].selectors.lsl).trigger("enterKey");
      __WEBPACK_IMPORTED_MODULE_3__Json__["a" /* Json */].prepareJSON('save', $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].selectors.lsl).val());
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].selectors.lsl).parent().parent().parent().parent().hide();
      __WEBPACK_IMPORTED_MODULE_7__Init__["a" /* Init */].setHeadSec();
    }
  }).on('keyup', `${__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.o}[${__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].handlers.r}="translate"] #output_code`, function (e) {
    if (e.keyCode === 45) {
    ...
    if ($(this).val() === 'true') {
      ...
      $(`.gotoItem[${__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].handlers.i}="${a}"]`).removeClass('redout').attr('title', '');
    } else {
      ...
      $(`.gotoItem[${__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].handlers.i}="${a}"]`).addClass('redout').attr('title', 'This Hero entry is not activated');
    }
  }).on('change', '.lsOptions', () => {
    try {
      if ($('.lsOptions').val() !== "" || $('.lsOptions').val() !== "undefined" || $('.lsOptions').val() !== undefined || $('.lsOptions').val() !== "null" || $('.lsOptions').val() !== null) {
        ...
        new __WEBPACK_IMPORTED_MODULE_9__Alert__["a" /* default */]('Please select a valid data item from the dropdown', 'error');
      }
    } catch (e) {
  ...
  $(window).on('scroll', () => {
    if ($(window).scrollTop() + $(window).height() > $(document).height() - 50) {
      $('.copy-zone').fadeIn(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min);
    } else {
      $('.copy-zone').fadeOut(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].animation.d.min);
    }
  }).on('resize', () => {
    __WEBPACK_IMPORTED_MODULE_1__Utilities__["a" /* Utilities */].scrollState('a');
  });
  $(document).on('keydown', e => {
    ...
    if (e.keyCode === 82 && e.ctrlKey) {
      __WEBPACK_IMPORTED_MODULE_2__Items__["a" /* Items */].deleteItems();
      e.preventDefault();
    }
    ...
    if (e.keyCode === 73 && e.ctrlKey && e.altKey) {
      ...
      $(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].selectors.number).focus();
      e.preventDefault();
    }
    ...
    if (e.keyCode === 69 && e.ctrlKey && e.altKey) {
      if (global.pfLang === __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].language.e) {
        global.pfLang = __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].language.f;
      } else if (global.pfLang === __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].language.f) {
        global.pfLang = __WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].language.e;
      }
      $('.btnSwitch').removeClass('view-active');
      $(`.btnSwitch[data-language="${global.pfLang}"]`).addClass('view-active');
      if ($(__WEBPACK_IMPORTED_MODULE_0__components_Config__["a" /* app */].objects.ro).children().not('.preview_warning').length > 0) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__Utilities__["a" /* Utilities */].scrollState('b');
...
// module
exports.push([module.i, "span.overlay_close, span.multiquery_close, span.renderer_close, span.help_close, span.select_content, span.overlay_validate, span.overlay_trim, span.overlay_translate {\r\n  padding: 20px;\r\n  float: right;\r\n  cursor: pointer;\r\n  margin: 0 0 10px 10px; }\r\n\r\n#help, #html-zone, #query-zone, #loadandsave-zone {\r\n  display: none;\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  top: 30px;\r\n  left: 0;\r\n  z-index: 80; }\r\n\r\n.help_content, .render_output {\r\n  position: relative;\r\n  height: 700px;\r\n  width: 100%;\r\n  margin: 0 auto;\r\n  background-color: #efefef;\r\n  padding: 10px 30px;\r\n  top: 60px;\r\n  box-shadow: 0 20px 20px -10px rgba(0, 0, 0, 0.3); }\r\n\r\n#O_o a:link, #O_o a:visited {\r\n  color: #b4c9dd;\r\n  border-bottom: #b4c9dd;\r\n  display: block;\r\n  padding: 8px;\r\n  text-decoration: none; }\r\n\r\n#O_o a:hover, #O_o a:active {\r\n  color: #fff;\r\n  border-bottom: #fff;\r\n  text-decoration: none; }\r\n\r\n.mini .subtitle, .empty_cart, .promo_banner, .footer_menu a {\r\n  font-family: Montserrat;\r\n  font-weight: bold;\r\n  text-transform: uppercase;\r\n  color: #241e0e;\r\n  display: block;\r\n  letter-spacing: 1px;\r\n  text-rendering: optimizeLegibility; }\r\n\r\n.empty_cart, .promo_banner, .fullsize .subtitle, .footer_menu a {\r\n  font-family: Montserrat;\r\n  font-weight: bold;\r\n  text-transform: uppercase;\r\n  color: #241e0e;\r\n  display: block;\r\n  letter-spacing: 1px;\r\n  text-rendering: optimizeLegibility; }\r\n\r\n.hepa, .hepaT {\r\n  margin-left: 10px;\r\n  font-size: 80%;\r\n  font-weight: normal; }\r\n\r\n.error_message, .warning_message {\r\n  display: inline-block !important;\r\n  margin-right: 10px;\r\n  cursor: pointer; }\r\n\r\n.error_bubble, .warning_bubble {\r\n  display: none;\r\n  position: absolute;\r\n  top: -134px;\r\n  background-color: #ddd;\r\n  padding: 10px;\r\n  border: 1px solid #bbb; }\r\n\r\nfieldset {\r\n  margin: 0 2px !important;\r\n  border: none !important;\r\n  padding: 0.35em 0.625em 0.75em !important; }\r\n\r\n#wrapper {\r\n  width: 980px;\r\n  margin: 70px auto 0 auto; }\r\n\r\n.form-group {\r\n  position: relative;\r\n  display: table;\r\n  width: 100%; }\r\n\r\n.half_span {\r\n  width: 50%;\r\n  float: left; }\r\n  .half_span.lItem {\r\n    padding-right: 20px; }\r\n\r\n#output {\r\n  position: absolute;\r\n  top: 30px;\r\n  left: 0;\r\n  width: 100%;\r\n  height: 100%;\r\n  display: none;\r\n  z-index: 10; }\r\n\r\n.blackify {\r\n  background-color: rgba(0, 0, 0, 0.5);\r\n  position: absolute;\r\n  top: 0;\r\n  left: 0;\r\n  width: 100%;\r\n  height: 100%; }\r\n\r\nhtml[data-theme=\"light\"] .blackify_overlay {\r\n  position: relative;\r\n  width: 100%;\r\n  height: 100%;\r\n  margin: 0 auto;\r\n  padding: 50px;\r\n  background-color: rgba(0, 0, 0, 0.5); }\r\n\r\nhtml[data-theme=\"light\"] body {\r\n  background-color: #fff; }\r\n\r\nhtml[data-theme=\"light\"] label {\r\n  color: #000; }\r\n\r\nhtml[data-theme=\"light\"] .panel-body:not(.input-group) {\r\n  background-color: #efefef; }\r\n\r\nhtml[data-theme=\"dark\"] .blackify_overlay {\r\n  position: relative;\r\n  width: 100%;\r\n  height: 100%;\r\n  margin: 0 auto;\r\n  padding: 50px;\r\n  background-color: rgba(0, 0, 0, 0.7); }\r\n\r\nhtml[data-theme=\"dark\"] body {\r\n  background-color: #666; }\r\n\r\nhtml[data-theme=\"dark\"] label {\r\n  color: #fff; }\r\n\r\nhtml[data-theme=\"dark\"] .panel-body:not(.input-group) {\r\n  background-color: #000; }\r\n\r\nhtml[data-theme=\"dark\"] .form-control:focus {\r\n  color: #fff; }\r\n\r\nhtml[data-theme=\"dark\"] .grouped_feature {\r\n  background-color: rgba(0, 0, 0, 0.3); }\r\n\r\nhtml[data-theme=\"dark\"] .inner_message {\r\n  color: #fff; }\r\n\r\nhtml[data-theme=\"dark\"] .form-control:focus {\r\n  color: #fff; }\r\n\r\nhtml[data-theme=\"dark\"] .inner_message {\r\n  color: #fff; }\r\n\r\nhtml[data-theme=\"dark\"] .dropdown-menu {\r\n  background-color: #666;\r\n  color: #fff; }\r\n\r\nhtml[data-theme=\"dark\"] .dropdown-menu a {\r\n  color: #fff; }\r\n  html[data-theme=\"dark\"] .dropdown-menu a:hover {\r\n    background-color: #555; }\r\n\r\nhtml[data-theme=\"dark\"] .dropdown-menu .divider {\r\n  background-color: rgba(0, 0, 0, 0.3); }\r\n\r\nspan.overlay_message {\r\n  padding: 20px;\r\n  float: left;\r\n  cursor: pointer;\r\n  margin: 0 0 10px 0;\r\n  background-color: #fff;\r\n  display: none; }\r\n\r\nspan.micro-aid {\r\n  font-size: 8px;\r\n  float: right;\r\n  padding-top: 6px; }\r\n\r\nlegend {\r\n  margin-top: 20px; }\r\n\r\nlabel {\r\n  margin-top: 10px; }\r\n\r\n.heading-reference {\r\n  padding: 10px 0;\r\n  margin: 20px 0 10px 10px; }\r\n\r\n.mod-radio {\r\n  padding-left: 50px;\r\n  border-left: 6px solid #68b81f;\r\n  border-radius: 5px;\r\n  transition: all 0.7s; }\r\n  .mod-radio:hover {\r\n    background-color: rgba(0, 0, 0, 0.08); }\r\n\r\n.panel-body {\r\n  position: relative; }\r\n  .panel-body.top_level_bt {\r\n    position: fixed;\r\n    width: 100%;\r\n    top: 0;\r\n    z-index: 99;\r\n    box-shadow: 0 0 20px rgba(0, 0, 0, 0.4); }\r\n\r\n.sub {\r\n  width: 100%;\r\n  margin: 0 auto; }\r\n\r\n.info-group {\r\n  position: relative;\r\n  display: inline-block;\r\n  float: right;\r\n  vertical-align: middle;\r\n  font-size: 22px;\r\n  margin-left: 5px;\r\n  cursor: pointer; }\r\n  .info-group .label {\r\n    border-left: 10px solid rgba(255, 255, 255, 0.3);\r\n    transition: all 0.5s; }\r\n    .info-group .label:hover {\r\n      border-radius: 0; }\r\n\r\n.clonedInput {\r\n  box-shadow: 0 16px 40px -20px rgba(0, 0, 0, 0.6); }\r\n\r\n.nopad {\r\n  padding: 0 !important;\r\n  background-color: transparent; }\r\n\r\n#output[data-reason=\"output\"] .overlay_translate {\r\n  display: none; }\r\n\r\n#output[data-reason=\"output\"] .select_content {\r\n  display: inline; }\r\n\r\n#output[data-reason=\"translate\"] .overlay_translate {\r\n  display: inline; }\r\n\r\n#output[data-reason=\"translate\"] .select_content {\r\n  display: none; }\r\n\r\n.copy-zone {\r\n  position: fixed;\r\n  bottom: 0;\r\n  right: 0;\r\n  padding: 20px;\r\n  background-color: rgba(221, 221, 221, 0.5);\r\n  display: none;\r\n  text-transform: uppercase;\r\n  font-weight: bold;\r\n  cursor: pointer; }\r\n\r\n.btn-group.errorList {\r\n  display: none;\r\n}\r\n\r\n.numerrors {\r\n  margin-left: 10px; }\r\n\r\n.redout {\r\n  background-color: rgba(255, 0, 0, 0.1);\r\n  border-left: 3px solid red; }\r\n\r\n#attribution {\r\n  font-size: 12px;\r\n  color: #999;\r\n  padding: 20px;\r\n  margin: 20px 0;\r\n  border-top: 1px solid #ccc; }\r\n\r\n.input_holders {\r\n  display: block;\r\n  position: relative; }\r\n\r\n.input_alerts {\r\n  display: inline-block;\r\n  position: absolute;\r\n  right: 0;\r\n  top: 0;\r\n  padding: 8px;\r\n  color: red;\r\n  cursor: pointer; }\r\n\r\n.help_content {\r\n  border-radius: 5px;\r\n  border-left: 5px solid #d9534f; }\r\n  .help_content h2 {\r\n    margin-bottom: 30px;\r\n    text-transform: uppercase; }\r\n\r\n.render_output {\r\n  height: auto !important; }\r\n\r\n.help_panel_holder {\r\n  height: 570px;\r\n  position: absolute;\r\n  overflow-y: auto;\r\n  width: auto; }\r\n  .help_panel_holder h4 {\r\n    font-weight: bold; }\r\n\r\n.previewItem {\r\n  font-size: 15px; }\r\n\r\n#O_o {\r\n  text-align: center;\r\n  background: #33577b;\r\n  color: #b4c9dd;\r\n  border-bottom: 1px solid #294663; }\r\n\r\n.renderSmall .action_button {\r\n  top: 30px;\r\n  position: relative; }\r\n\r\n.renderSmall .headline.herobanner {\r\n  font-size: 35px;\r\n  line-height: 45px;\r\n  top: -120px; }\r\n\r\n.renderSmall .timedown.is-countdown {\r\n  top: -130px;\r\n  position: relative; }\r\n\r\n.renderSmall .subtitle:not(.is-countdown) {\r\n  top: -70px; }\r\n\r\n@media screen and (max-width: 620px) and (max-device-width: 620px) {\r\n  #wrapper {\r\n    width: 90%; }\r\n  legend {\r\n    font-size: 24px;\r\n    font-weight: 500; } }\r\n\r\n.panel-default {\r\n  box-shadow: 0 20px 50px #b3b3b3; }\r\n\r\n.panel-heading {\r\n  text-transform: uppercase; }\r\n\r\n.page-header {\r\n  border-bottom: none !important; }\r\n\r\n.color-blocks {\r\n  display: block;\r\n  height: 30px;\r\n  padding-top: 30px; }\r\n\r\n.global {\r\n  width: 50%;\r\n  margin: 0 auto; }\r\n\r\n.well-lg {\r\n  height: 65%;\r\n  width: 50%;\r\n  margin: 6% auto 0 auto; }\r\n\r\n.see_overlay {\r\n  position: absolute;\r\n  width: 100%;\r\n  height: 100%;\r\n  display: none; }\r\n\r\n#content_value {\r\n  width: 100%;\r\n  height: 90%; }\r\n\r\n#cleaner_content_value {\r\n  width: 100%;\r\n  height: 90%; }\r\n\r\n#cleaner_error_value {\r\n  width: 100%;\r\n  height: 90%; }\r\n\r\n.button_holder {\r\n  display: block;\r\n  margin-bottom: 30px;\r\n  height: auto; }\r\n\r\n.selector-color {\r\n  display: inline-block;\r\n  margin: -5px 10px;\r\n  width: 20px;\r\n  height: 20px;\r\n  font-size: 18px;\r\n  cursor: pointer;\r\n  border: 1px solid #ccc; }\r\n\r\n.white {\r\n  background-color: #fff; }\r\n\r\n.black {\r\n  background-color: #000; }\r\n  .black.glyphicon.glyphicon-ok {\r\n    color: #fff !important; }\r\n\r\n.green {\r\n  background-color: #9bd000; }\r\n  .green.glyphicon.glyphicon-ok {\r\n    color: #000 !important; }\r\n\r\n.red {\r\n  background-color: #ee3600; }\r\n  .red.glyphicon.glyphicon-ok {\r\n    color: #fff !important; }\r\n\r\n.mini #event-active-today {\r\n  float: left;\r\n  padding: 0;\r\n  width: 380px !important;\r\n  height: 425px;\r\n  position: relative;\r\n  border-bottom: 5px solid #241e0e;\r\n  margin-right: 40px;\r\n  overflow: hidden; }\r\n  .mini #event-active-today .event-active-bg {\r\n    position: absolute;\r\n    max-height: 425px;\r\n    background-position: center;\r\n    background-size: cover;\r\n    width: 100%;\r\n    height: 100%; }\r\n  .mini #event-active-today .event-active-content {\r\n    z-index: 262;\r\n    position: absolute;\r\n    width: 100%;\r\n    padding: 0 10px;\r\n    top: 75px; }\r\n    .mini #event-active-today .event-active-content .headline {\r\n      padding: 5px;\r\n      text-align: center;\r\n      font-size: 35px;\r\n      line-height: 35px;\r\n      color: #fff; }\r\n    .mini #event-active-today .event-active-content .subtitle {\r\n      position: absolute;\r\n      padding: 5px;\r\n      text-align: center;\r\n      margin: 0 -10px;\r\n      top: 190px;\r\n      font-size: 14px;\r\n      width: 100%; }\r\n  .mini #event-active-today .event-active-cta {\r\n    padding: 10px;\r\n    position: absolute;\r\n    right: 15%;\r\n    bottom: 0; }\r\n    .mini #event-active-today .event-active-cta a {\r\n      box-shadow: 8px 8px 20px -12px #000;\r\n      width: 250px;\r\n      display: block !important; }\r\n\r\n.mini .headline {\r\n  text-shadow: 2px 2px 20px #000;\r\n  font-size: 50px;\r\n  margin-bottom: 0.2em;\r\n  line-height: 55px;\r\n  font-weight: bold;\r\n  position: relative;\r\n  letter-spacing: 1px; }\r\n\r\n.mini .subtitle:not(.is-countdown) {\r\n  color: #fff;\r\n  background: rgba(0, 0, 0, 0.6);\r\n  font-size: 80%;\r\n  line-height: 1.5em;\r\n  font-weight: normal;\r\n  position: relative; }\r\n\r\n.mini .event-active-bg img {\r\n  max-height: 425px; }\r\n\r\n.mini .b_line_exo.is-countdown {\r\n  position: absolute;\r\n  bottom: 80px;\r\n  width: 91%;\r\n  text-align: center;\r\n  text-transform: uppercase;\r\n  line-height: 20px;\r\n  z-index: 99;\r\n  color: #fff; }\r\n  .mini .b_line_exo.is-countdown span:not(.force_lower) {\r\n    background-color: rgba(0, 0, 0, 0.4);\r\n    border-bottom: 2px solid #9bd000;\r\n    padding: 5px; }\r\n\r\n.fullsize .bcg {\r\n  background-repeat: no-repeat;\r\n  background-attachment: fixed;\r\n  background-size: cover; }\r\n\r\n.fullsize.renderSmall .bcg {\r\n  background-repeat: no-repeat;\r\n  background-attachment: initial;\r\n  background-size: cover; }\r\n\r\n.fullsize .hsContainer {\r\n  height: 550px;\r\n  display: table;\r\n  table-layout: fixed;\r\n  width: 100%;\r\n  overflow: hidden;\r\n  position: relative;\r\n  opacity: 1; }\r\n\r\n.fullsize .hsContent {\r\n  max-width: 1180px;\r\n  margin: -150px auto 0 auto;\r\n  display: table-cell;\r\n  vertical-align: middle;\r\n  text-align: center;\r\n  float: none; }\r\n\r\n.fullsize #event-active-today {\r\n  padding: 0;\r\n  width: 380px !important;\r\n  height: 425px;\r\n  position: relative;\r\n  border-bottom: 5px solid #241e0e;\r\n  margin: 0 auto;\r\n  overflow: hidden; }\r\n  .fullsize #event-active-today .event-active-bg {\r\n    position: absolute;\r\n    max-height: 425px;\r\n    background-position: center;\r\n    background-size: cover;\r\n    width: 100%;\r\n    height: 100%; }\r\n  .fullsize #event-active-today .event-active-content {\r\n    z-index: 262;\r\n    position: absolute;\r\n    width: 100%;\r\n    padding: 0 10px;\r\n    top: 75px; }\r\n    .fullsize #event-active-today .event-active-content .headline {\r\n      padding: 5px;\r\n      text-align: center;\r\n      font-size: 35px;\r\n      line-height: 35px;\r\n      color: #fff; }\r\n    .fullsize #event-active-today .event-active-content .subtitle {\r\n      position: absolute;\r\n      padding: 5px;\r\n      text-align: center;\r\n      margin: 0 -10px;\r\n      top: 190px;\r\n      font-size: 14px;\r\n      width: 100%; }\r\n  .fullsize #event-active-today .event-active-cta {\r\n    padding: 10px;\r\n    position: absolute;\r\n    right: 15%;\r\n    bottom: 0; }\r\n    .fullsize #event-active-today .event-active-cta a {\r\n      box-shadow: 8px 8px 20px -12px #000;\r\n      width: 250px;\r\n      display: block !important; }\r\n\r\n.fullsize .headline {\r\n  color: #fff;\r\n  text-shadow: 2px 2px 20px #000;\r\n  font-size: 50px;\r\n  margin-bottom: 0.2em;\r\n  line-height: 55px;\r\n  font-weight: bold;\r\n  position: relative;\r\n  letter-spacing: 1px; }\r\n\r\n.fullsize .subtitle:not(.is-countdown) {\r\n  color: #fff;\r\n  background: rgba(0, 0, 0, 0.6);\r\n  font-size: 80%;\r\n  line-height: 1.5em;\r\n  font-weight: normal;\r\n  position: relative; }\r\n\r\n.fullsize .event-active-bg img {\r\n  max-height: 425px; }\r\n\r\n.error_log {\r\n  display: inline-block;\r\n  padding: 10px 5px 0 20px;\r\n  vertical-align: middle;\r\n  position: relative;\r\n  width: 70%; }\r\n\r\n.warning_bubble {\r\n  left: 100px; }\r\n\r\n.label-info {\r\n  margin-left: 5px;\r\n  cursor: pointer; }\r\n\r\n.tooltip {\r\n  display: none;\r\n  position: absolute;\r\n  border: 1px solid #333;\r\n  background-color: #5bc0de;\r\n  border-radius: 5px;\r\n  padding: 10px;\r\n  color: #fff;\r\n  font-size: 12px; }\r\n\r\n.need_help {\r\n  cursor: pointer; }\r\n\r\n.alert {\r\n  border-radius: 0 !important;\r\n  font-size: 16px;\r\n  padding-left: 30px;\r\n  text-transform: uppercase;\r\n  font-weight: bold;\r\n  position: relative; }\r\n\r\n.add_icon {\r\n  position: absolute;\r\n  right: 20px;\r\n  top: 5px;\r\n  font-size: 45px; }\r\n\r\n.badge {\r\n  margin-right: 10px; }\r\n\r\n.see_help_overlay {\r\n  display: none; }\r\n\r\n.help_message_holder .label {\r\n  font-size: 100% !important; }\r\n\r\n.help_message_holder .label-info {\r\n  cursor: default; }\r\n  .help_message_holder .label-info:last-of-type {\r\n    margin-left: 0 !important; }\r\n\r\n.help_message_holder p:nth-of-type(1):before {\r\n  content: '';\r\n  height: 40px;\r\n  clear: both;\r\n  display: block; }\r\n\r\n.autosuggest {\r\n  position: absolute;\r\n  bottom: -11px;\r\n  background-color: #fff;\r\n  width: 92%;\r\n  left: 1px;\r\n  margin: -5px 15px;\r\n  padding: 5px;\r\n  border: 1px solid #ccc;\r\n  box-sizing: border-box; }\r\n  .autosuggest select {\r\n    font-size: 12px; }\r\n    .autosuggest select.w_minor {\r\n      width: 45px;\r\n      font-size: 12px; }\r\n\r\n.starting {\r\n  display: none; }\r\n\r\n.ending {\r\n  display: none; }\r\n\r\n.sparta {\r\n  position: absolute !important;\r\n  top: 26px;\r\n  left: 285px;\r\n  z-index: 10;\r\n  cursor: pointer; }\r\n\r\n.athena {\r\n  position: absolute !important;\r\n  top: 26px;\r\n  left: 285px;\r\n  z-index: 10;\r\n  cursor: pointer; }\r\n\r\n.version {\r\n  display: inline-block;\r\n  margin-right: 10px;\r\n  cursor: pointer; }\r\n\r\n.revision {\r\n  display: inline-block;\r\n  margin-right: 10px;\r\n  cursor: pointer; }\r\n\r\n.build {\r\n  display: inline-block;\r\n  margin-right: 10px;\r\n  cursor: pointer; }\r\n\r\n.minified {\r\n  display: inline-block;\r\n  margin-right: 10px; }\r\n\r\n.object.lineitem {\r\n  display: inline-block;\r\n  margin-right: 30px; }\r\n\r\n.object.checks {\r\n  display: inline-block;\r\n  position: absolute;\r\n  right: 20px;\r\n  top: 20px;\r\n  color: #5cb85c;\r\n  font-size: 25px; }\r\n\r\n.object.semantic > * {\r\n  display: inline-block;\r\n  margin-right: 10px; }\r\n\r\n.line-error {\r\n  cursor: pointer; }\r\n\r\n.line-update {\r\n  cursor: pointer; }\r\n\r\n.release-data {\r\n  width: 800px;\r\n  height: 600px;\r\n  overflow-y: auto;\r\n  overflow-x: hidden; }\r\n\r\n#results-alert {\r\n  display: none; }\r\n\r\n.partridge {\r\n  float: right; }\r\n\r\n.snapright {\r\n  float: right; }\r\n\r\n.blackify_overlay textarea {\r\n  width: 100% !important;\r\n  height: 85% !important;\r\n  font-family: monospace;\r\n  font-size: 12px; }\r\n\r\n.open > .dropdown-menu {\r\n  display: block;\r\n  min-width: 280px; }\r\n\r\n.btn-group.bigboy button {\r\n  display: inline;\r\n  padding: .2em .6em .3em;\r\n  font-size: 30px;\r\n  font-weight: 700;\r\n  line-height: 1;\r\n  color: #fff;\r\n  text-align: center;\r\n  white-space: nowrap;\r\n  vertical-align: baseline;\r\n  border-radius: 5px; }\r\n  .btn-group.bigboy button .label {\r\n    font-size: 15px;\r\n    vertical-align: middle; }\r\n\r\n.btn-group.bigboy.pushDown {\r\n  margin: 15px 0 30px 0; }\r\n\r\nh4.push_block {\r\n  margin-top: 40px; }\r\n\r\ninput#image_gl {\r\n  text-transform: lowercase; }\r\n\r\np.subtitle.timedown {\r\n  color: #fff; }\r\n  p.subtitle.timedown b {\r\n    color: #fff;\r\n    padding: 1px 3px;\r\n    background: #ee3600;\r\n    margin: 0 auto 15px auto; }\r\n  p.subtitle.timedown small {\r\n    font-size: 50%; }\r\n\r\n.subtitle.timedown.is-countdown span:not(.force_lower) {\r\n  background-color: rgba(0, 0, 0, 0.5); }\r\n\r\na.action_button {\r\n  background: #ee3600;\r\n  color: #fff;\r\n  border: 0;\r\n  padding: 8px 20px;\r\n  text-align: center;\r\n  cursor: pointer;\r\n  font-family: Montserrat;\r\n  font-weight: bold;\r\n  font-size: 16px;\r\n  text-transform: uppercase;\r\n  display: inline-block;\r\n  transition: all 200ms ease 0s;\r\n  border-radius: 2px;\r\n  font-smoothing: antialiased;\r\n  box-sizing: border-box; }\r\n  a.action_button.hero {\r\n    pointer-events: none; }\r\n\r\ndiv#html-view {\r\n  position: absolute;\r\n  top: 0;\r\n  margin-top: 8%; }\r\n\r\n.label span {\r\n  margin-right: 5px; }\r\n\r\n.top_level_bt.stick {\r\n  position: fixed;\r\n  top: 0;\r\n  z-index: 10000;\r\n  border-radius: 0 0 0.5em 0.5em; }\r\n\r\n.panel.panel-default {\r\n  margin-top: 20px; }\r\n\r\nh1 .label-default {\r\n  font-size: 12px;\r\n  margin-left: 10px; }\r\n\r\n.moveUpThisItem span:not([data-lang-id]), .moveDownThisItem span:not([data-lang-id]) {\r\n  float: right;\r\n  font-size: 12px; }\r\n\r\n.errorListing {\r\n  max-height: 500px;\r\n  overflow-y: auto; }\r\n\r\n.errorItem.true {\r\n  color: red;\r\n  transition: all 0.4s; }\r\n  .errorItem.true:hover {\r\n    background-color: red;\r\n    color: #fff; }\r\n\r\ninput.hero_num {\r\n  width: 25px;\r\n  height: 20px;\r\n  position: absolute;\r\n  top: 9px;\r\n  left: 49px; }\r\n\r\n.question_num, .question_loader, .saveme_loader {\r\n  background-color: #fff;\r\n  width: 100%;\r\n  margin: 60px auto;\r\n  top: 50px;\r\n  padding: 5px 50px; }\r\n  .question_num .subs, .question_loader .subs, .saveme_loader .subs {\r\n    background-color: #fff;\r\n    width: 100%;\r\n    margin: 50px auto;\r\n    top: 50px; }\r\n\r\nspan.show_me_how {\r\n  cursor: pointer;\r\n  color: green;\r\n  position: relative;\r\n  top: 1px;\r\n  display: inline-block;\r\n  font-family: 'Glyphicons Halflings';\r\n  font-style: normal;\r\n  font-weight: 400;\r\n  line-height: 1;\r\n  -webkit-font-smoothing: antialiased;\r\n  -moz-osx-font-smoothing: grayscale; }\r\n  span.show_me_how:before {\r\n    content: \"\\E085\"; }\r\n\r\n.preview_warning {\r\n  position: absolute;\r\n  background-color: rgba(255, 255, 255, 0.5);\r\n  padding: 5px;\r\n  bottom: 10px;\r\n  right: 30px;\r\n  border-left: 3px solid rgba(0, 0, 0, 0.51);\r\n  border-top: 3px solid rgba(0, 0, 0, 0.51);\r\n  cursor: pointer; }\r\n\r\n.grouped_feature {\r\n  padding: 0 20px 20px 20px;\r\n  background-color: rgba(221, 221, 221, 0.4);\r\n  border-left: 6px solid #5bc0de;\r\n  border-right: 6px solid rgba(91, 192, 222, 0.2);\r\n  border-radius: 5px;\r\n  box-shadow: inset 10px 1px 100px -58px rgba(0, 0, 0, 0.5);\r\n  transition: all 0.5s; }\r\n  .grouped_feature:hover {\r\n    border-right: 6px solid #5bc0de;\r\n    border-left: 6px solid rgba(91, 192, 222, 0.2); }\r\n\r\n.main_nav[role=\"menu\"] {\r\n  border-left: 5px solid #398439; }\r\n\r\n.custom_prog {\r\n  /* Positioning */\r\n  position: fixed;\r\n  left: 0;\r\n  top: 62px;\r\n  /* Dimensions */\r\n  width: 100%;\r\n  height: 2px;\r\n  /* Reset the appearance */\r\n  -webkit-appearance: none;\r\n  -moz-appearance: none;\r\n  appearance: none;\r\n  /* Get rid of the default border in Firefox/Opera. */\r\n  border: none;\r\n  /* Progress bar container for Firefox/IE10+ */\r\n  background-color: transparent;\r\n  /* Progress bar value for IE10+ */\r\n  color: #5bc0de; }\r\n\r\n.custom_prog::-webkit-progress-bar {\r\n  background-color: transparent; }\r\n\r\n.custom_prog::-webkit-progress-value {\r\n  background-color: #5bc0de; }\r\n\r\n.custom_prog::-moz-progress-bar {\r\n  background-color: #5bc0de; }\r\n\r\n.panel-body.bottom_level_bt {\r\n  display: none;\r\n  position: fixed;\r\n  width: 100%;\r\n  bottom: 0;\r\n  height: 80px;\r\n  z-index: 99;\r\n  box-shadow: 0 0 20px rgba(0, 0, 0, 0.4); }\r\n\r\n.message_pane {\r\n  width: 50%;\r\n  margin: 0 auto;\r\n  text-align: center;\r\n  height: 80px; }\r\n\r\n.leftAlign {\r\n  float: left;\r\n  font-size: 40px; }\r\n\r\n.allGood {\r\n  color: green; }\r\n\r\n.allBad {\r\n  color: red; }\r\n\r\n.inner_message {\r\n  vertical-align: middle;\r\n  padding: 15px; }\r\n\r\n.helpItem {\r\n  cursor: pointer; }\r\n\r\n.form-control {\r\n  transition: all 0.5s !important; }\r\n  .form-control:focus {\r\n    border-color: #4cae4c;\r\n    background-color: rgba(0, 0, 0, 0.05) !important;\r\n    border-left-width: 6px; }\r\n\r\n#loadandsave-zone[data-reason=\"load\"] .question_loader {\r\n  display: block; }\r\n\r\n#loadandsave-zone[data-reason=\"load\"] .saveme_loader {\r\n  display: none; }\r\n\r\n#loadandsave-zone[data-reason=\"save\"] .question_loader {\r\n  display: none; }\r\n\r\n#loadandsave-zone[data-reason=\"save\"] .saveme_loader {\r\n  display: block; }\r\n\r\n.reordered {\r\n  font-size: 20px;\r\n  margin-right: 10px; }\r\n\r\n.image_count {\r\n  cursor: pointer; }\r\n\r\n.view-active {\r\n  border-right: 5px solid rgba(0, 0, 0, 0.4);\r\n  background: rgba(221, 221, 221, 0.3); }\r\n\r\n*[data-role=\"hello\"] {\r\n  display: none; }\r\n\r\n*[data-role=\"altiSpecial\"] {\r\n  display: none; }\r\n\r\nbody[data-nmode=\"hello\"] *[data-role=\"hero\"] {\r\n  display: none; }\r\n\r\nbody[data-nmode=\"hello\"] *[data-role=\"altiSpecial\"] {\r\n  display: none; }\r\n\r\nbody[data-nmode=\"hero\"] *[data-role=\"hello\"] {\r\n  display: none; }\r\n\r\nbody[data-nmode=\"hero\"] *[data-role=\"altiSpecial\"] {\r\n  display: none; }\r\n\r\n.init-update {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  top: 30px;\r\n  left: 0;\r\n  z-index: 80; }\r\n\r\n.prompt-update {\r\n  position: relative;\r\n  height: 200px;\r\n  width: 50%;\r\n  margin: 0 auto;\r\n  background-color: #efefef;\r\n  padding: 10px 30px;\r\n  top: 60px;\r\n  box-shadow: 0 20px 20px -10px rgba(0, 0, 0, 0.3); }\r\n\r\n.prompt-choice {\r\n  position: absolute;\r\n  bottom: 20px; }\r\n\r\n.btn-update {\r\n  margin-right: 10px; }\r\n  .btn-update.true {\r\n    color: #fff;\r\n    background-color: #5cb85c;\r\n    border-color: #4cae4c; }\r\n  .btn-update.false {\r\n    color: #fff;\r\n    background-color: #d9534f;\r\n    border-color: #4cae4c; }\r\n\r\n.prompt-message, .prompt-icon {\r\n  display: inline-block; }\r\n\r\n@keyframes mymove {\r\n  0% {\r\n    color: #5bc0de;\r\n    opacity: 1; }\r\n  25% {\r\n    color: #fff;\r\n    opacity: 0.5; }\r\n  50% {\r\n    color: #5cb85c;\r\n    opacity: 1; }\r\n  75% {\r\n    color: #fff;\r\n    opacity: 0.5; }\r\n  100% {\r\n    color: #5bc0de;\r\n    opacity: 1; } }\r\n\r\n.prompt-icon {\r\n  font-size: 60px;\r\n  margin-right: 20px;\r\n  color: #5bc0de;\r\n}\r\n  .prompt-icon span {\r\n    text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.39);\r\n    animation: mymove 4s infinite;\r\n  }\r\n.com_API_local {\r\n  display: none;\r\n  position: absolute;\r\n  width: 100%;\r\n  height: 100%;\r\n  background-color: rgba(0,0,0,0.5);\r\n  z-index: 99;\r\n}\r\n\r\n.com_API_message {\r\n  position: relative;\r\n  width: 980px;\r\n  height: 70px;\r\n  margin: auto;\r\n  top: 25%;\r\n  background: #fff;\r\n  /* padding: 10px; */\r\n  border-radius: 4px;\r\n}\r\n.com_API_prog {\r\n  position: absolute;\r\n  left: 0;\r\n  /* top: 62px; */\r\n  width: 0;\r\n  height: 32px;\r\n  -webkit-appearance: none;\r\n  -moz-appearance: none;\r\n  appearance: none;\r\n  border: none;\r\n  background-color: #5bc0de;\r\n  color: #5bc0de;\r\n  border-top-right-radius: 4px;\r\n  border-top-left-radius: 4px;\r\n}\r\n\r\n.com_API_state {\r\n  padding: 10px;\r\n  position: absolute;\r\n  top: 30px;\r\n}\r\n.option-selection {\r\n  display: none;\r\n}\r\n.dropdown-menu>li>a{\r\n  cursor: pointer;\r\n}", ""]);
...
/* WEBPACK VAR INJECTION */(function(global, $) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_globals_css__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_lib_bootstrap_datetimepicker_min_css__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_lib_bootstrap_min_css__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_lib_bootstrap_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__assets_lib_bootstrap_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_lib_bootstrap_min__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_lib_bootstrap_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__assets_lib_bootstrap_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_lib_bootstrap_datetimepicker_min__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_lib_bootstrap_datetimepicker_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__assets_lib_bootstrap_datetimepicker_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_fonts_webFont_css__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_fonts_webFont_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__assets_fonts_webFont_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Config__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Init__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Language__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_EventHandlers__ = __webpack_require__(21);
/**
 * Created by David Maser on 09/06/2017.
 */
...
global.pfHero = 0;
global.pfMode = __WEBPACK_IMPORTED_MODULE_6__components_Config__["a" /* app */].params.s;
global.pfExport = 'hero';
global.sPos = 0;
global.pfLang = __WEBPACK_IMPORTED_MODULE_6__components_Config__["a" /* app */].lang;

$(() => {
  __WEBPACK_IMPORTED_MODULE_7__components_Init__["a" /* Init */].setHeadSec();
  __WEBPACK_IMPORTED_MODULE_7__components_Init__["a" /* Init */].initializeTheme();
  ...
  new __WEBPACK_IMPORTED_MODULE_8__components_Language__["a" /* Language */](__WEBPACK_IMPORTED_MODULE_6__components_Config__["a" /* app */].lang, true);
  $('.date_obj').datetimepicker({format: 'MM/DD/YYYY HH:mm'});
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_validate_json__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_validate_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lib_validate_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Config__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Items__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Errors__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Storage__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Alert__ = __webpack_require__(2);
/**
 * Created by David Maser on 09/06/2017.
 */
...
const Json = {
  validateJSON() {
    $("#output_code").validateJSON({
      ...
      reformat: true,
      onSuccess: (json) => {
        new __WEBPACK_IMPORTED_MODULE_5__Alert__["a" /* default */]('JSON Code is valid', 'good');
      },
      onError: (error) => {
        new __WEBPACK_IMPORTED_MODULE_5__Alert__["a" /* default */]('A JSON error has been encountered. The line on which the error has occured is highlighted.', 'error');
      }
    })
  },
  /**
  ...
  traverseJSON(storage, nodeName, fromAJAX) {
    ...
    if ($(`${__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.b} textarea`).val() !== '' || localStorage.getItem('pgb_SavedNode') !== '' && fromAJAX === undefined) {
      if (storage === false) {
        ...
        if (ctc === '') {
          new __WEBPACK_IMPORTED_MODULE_5__Alert__["a" /* default */]('Form Does Not Contain JSON Data', 'error');
        }
        ...
        if (localStorage.getItem(`pgb_SavedNode_${nodeName}`) !== undefined && localStorage.getItem(`pgb_SavedNode_${nodeName}`) !== null && localStorage.getItem(`pgb_SavedNode_${nodeName}`) !== '') {
          ...
          new __WEBPACK_IMPORTED_MODULE_5__Alert__["a" /* default */]('No Data Found In Local Storage', 'error');
        }
      }
      ...
      new __WEBPACK_IMPORTED_MODULE_5__Alert__["a" /* default */]('Data Translated To Form', 'good');
    } else if (fromAJAX !== '') {
      if (storage === false) {
        ctc = fromAJAX;
        if (ctc === '') {
      ...
      new __WEBPACK_IMPORTED_MODULE_5__Alert__["a" /* default */]('Please generate or paste JSON before using this function', 'error');
    }
  },
  /**
  ...
  jsonToForm(aCode) {
    ...
    for (let i = 0; i < jsLen; i++) {
      ...
      if (aCode[i].date.delay === true || aCode[i].date.delay === false) {
        window.setTimeout(() => {
          new __WEBPACK_IMPORTED_MODULE_5__Alert__["a" /* default */]('Some delay entries are not numerical. Make sure to set all delay entries to a numerical value manually.', 'error');
        }, 2000);
      ...
      if ($(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.o).css('display') == 'block') {
        $(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.o).hide();
        $(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.r).css('overflow', 'auto');
      }
      $(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.r).css('overflow', 'auto');
    }
  },
  ...
  outputJson(aCode, meth, name, mode) {
    try {
      ...
      if (meth === 'full') {
        if ($(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.he).css('display') === 'block') {
          $(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.he).css('display', 'none');
        }
        if ($(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.h).css('display') === 'block') {
          $(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.h).css('display', 'none');
        }
        if ($(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.ls).css('display') === 'block') {
          $(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.ls).css('display', 'none');
        }
        $(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.o).attr(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].handlers.r, 'output');
        $(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.o).css('display', 'block');
        $(`${__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.o} textarea`).val(page_model);
        $(__WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].objects.r).animate({scrollTop: 0}, __WEBPACK_IMPORTED_MODULE_1__Config__["a" /* app */].animation.d.min).css('overflow', 'hidden');
        if (mode === 'hero') {
          new __WEBPACK_IMPORTED_MODULE_3__Errors__["a" /* Errors */]();
        }
        new __WEBPACK_IMPORTED_MODULE_5__Alert__["a" /* default */]('JSON Exported Successfully', 'good');
      } else {
        __WEBPACK_IMPORTED_MODULE_4__Storage__["a" /* Storage */].saveNodeToLS(page_model, name);
      }
    } catch (e) {
      new __WEBPACK_IMPORTED_MODULE_5__Alert__["a" /* default */]('An unknown error has occured. Please make sure all required fields are filled.', 'error');
    }
  }
};
/* harmony export (immutable) */ __webpack_exports__["a"] = Json;
...
class Preview{
  ...
  previewFeature(heroItem, mode, lang) {
    const dt = $(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.e + heroItem).find('form').find('fieldset[data-role="hero"]').serializeArray();
    console.log(dt[2],lang,__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].language.e,__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].language.f)
    ...
    if (lang === __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].language.e) {
      titleText = dt[2].value;
      subTitleText = dt[5].value;
      buttonLabel = dt[11].value;
      endsLabel = 'Ends In';
    } else if (lang === __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].language.f) {
    ...
    const container = __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.h;
...
const Validator = {
  ...
  validateImage(type, handler) {
    if (type === 'main') {
      let a = $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.c}[${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.d}="${handler}"]`).parent().parent().parent().parent().parent().parent().parent().parent().find('.main_image').val();
      let aa = $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.c}[${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.d}="${handler}"]`).parent().parent().parent().parent().parent().parent().parent().parent().find('.main_image');
      let aaa = $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.c}[${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.d}="${handler}"]`).parent().parent().parent().parent().parent().parent().parent().parent().find('.main_image').parent().attr('class');
      if (a !== '') {
      ...
      let a = $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.ca}[${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.d}="${handler}"]`).parent().parent().parent().parent().parent().parent().parent().parent().find('.alt_image').val();
      let aa = $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.ca}[${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.d}="${handler}"]`).parent().parent().parent().parent().parent().parent().parent().parent().find('.alt_image');
      let aaa = $(`${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].objects.ca}[${__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* app */].handlers.d}="${handler}"]`).parent().parent().parent().parent().parent().parent().parent().parent().find('.alt_image').parent().attr('class');
      if (a !== '') {
...
/* WEBPACK VAR INJECTION */(function(jQuery, process) {/**
